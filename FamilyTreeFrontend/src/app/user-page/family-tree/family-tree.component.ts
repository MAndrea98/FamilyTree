...
export class FamilyTreeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    chart.load([       
          { id: 1, tags: ["blue", "black"], name: "King George VI", img: "https://cdn.balkan.app/shared/f1.png", date: "1895-1952"},
          { id: 2, pid: 1, tags: ["partner", "black"], name: "Queen Elizabeth", title: "The Queen Mother", img: "https://cdn.balkan.app/shared/f2.png", date:"1900-2002"},
          ...
          { id: 5, pid: 1, ppid: 2, tags:["black"], name: "Princess Margaret", img: "https://cdn.balkan.app/shared/f6.png"},
          { id: 6, pid: 3, tags: ["blue"], ppid: 4, name: "Charles", title: "Prince of Wales", img: "https://cdn.balkan.app/shared/f8.png"},
          { id: 7, pid: 6, tags: ["partner", "black"] , name: "Diana", title: "Princess of Wales", img: "https://cdn.balkan.app/shared/f9.png"},
          ...
          { id: 19, pid: 13, ppid: 15, name: "Archie Maunbathen", img: ""},
          { id: 20, pid: 9, tags:["partner"], name: "Mark Phillips", img: "" },
          { id: 21, pid: 9, ppid:20, name: "Sarah Tindall", img: ""},
          { id: 22, pid: 9, ppid:20, name: "Peter Phillips", img: ""},
          { id: 23, pid: 9, tags:["partner"], name: "Timothy Laurence", img: "" }
    ]);
  }
