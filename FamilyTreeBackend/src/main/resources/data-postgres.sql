...
insert into person (family_tree_id, name, gender, date, title, image, father_id, mother_id) values (1,'Charles',            0, '1948-',     'Price of Wales',      'https://cdn.balkan.app/shared/f8.png', 3, 4);
...
insert into person (family_tree_id, name, gender, date, title, image, father_id, mother_id) values (1,'Archie Mountbatten-Windsor', 0, '2019-', '', '', 13, 15);
